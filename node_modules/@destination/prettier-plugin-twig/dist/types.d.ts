...
export declare type CommonKeys<T1, T2> = Extract<keyof T1, keyof T2>;
export declare type AstPath<T = any> = Pick<AstPath2<T>, CommonKeys<AstPath2<T>, AstPath3<T>>>;
export declare type ParserOptions<T = any> = ParserOptions3<T>;
